...
# 3. ckBTC and Bitcoin integration
...
At the core of this integration is a novel protocol for chain-key signatures that is based on **threshold ECDSA**. [Threshold ECDSA](https://internetcomputer.org/docs/current/developer-docs/integrations/t-ecdsa/t-ecdsa-how-it-works) is a protocol suite that includes several features that include [key generation](https://csrc.nist.gov/glossary/term/key_generation), [periodic key re-sharing](https://www.youtube.com/watch?v=gKUi-2T7tdc), [computing pre-signatures](https://internetcomputer.org/docs/current/developer-docs/integrations/t-ecdsa/t-ecdsa-how-it-works/#:~:text=Computing%20pre%2Dsignatures%2C%20signing%3A,requests%20to%20precompute%20pre%20signatures), [XNet key re-sharing](https://internetcomputer.org/docs/current/developer-docs/integrations/t-ecdsa/t-ecdsa-how-it-works/#:~:text=XNet%20key%20re,source%20subnet%20uses), and public key retrieval.
...
The developer journey will dive deeper into threshold ECDSA in a future tutorial. You can also take a deep dive in the [technology overview to learn more](https://internetcomputer.org/docs/current/developer-docs/integrations/t-ecdsa/t-ecdsa-how-it-works).
...
```bash
git clone https://github.com/demergent-labs/azle
cd examples/bitcoin
```

:::info
You can copy the bitcoin example and past it in your own folder.
:::
...
- [4 NNS governance and staking](/docs/developer-journey/level-3/4-nns-and-staking.mdx).
