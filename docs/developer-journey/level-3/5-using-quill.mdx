...
[Read more about different types of self-custody wallet options in the documentation](https://internetcomputer.org/docs/current/developer-docs/defi/asset-custody/custody-options).
...
In the previous module, [4.4 NNS governance and staking](/docs/developer-journey/level-3/4-nns-and-staking.mdx), you took a look at how to interact with the NNS and neurons through the NNS dapp. Now, let's look at how to use quill instead to perform the same functions.
...
- [Quill CLI reference](https://internetcomputer.org/docs/current/developer-docs/developer-tools/cli-tools/quill-cli-reference/)
