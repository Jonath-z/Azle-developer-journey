...
[Learn more about neurons and their attributes](https://internetcomputer.org/docs/current/tokenomics/nns/nns-intro#neurons).
...
[View detailed information about different proposal types and topics](https://internetcomputer.org/docs/current/tokenomics/nns/nns-intro#topics).
...
- SNS [ledger](https://internetcomputer.org/docs/current/developer-docs/daos/sns/integrating/ledger-integration) and archive canisters.

- SNS [index](https://internetcomputer.org/docs/current/developer-docs/daos/sns/integrating/index-integration) canister.

- SNS root canister.

- SNS decentralization swap canister.

[Learn more about SNS architecture](https://internetcomputer.org/docs/current/developer-docs/daos/sns/introduction/sns-architecture).
...
- [SNS tokenomics](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/tokenomics-intro).

- [SNS rewards](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/rewards).

## SNS resources

To learn more about creating, launching, and managing an SNS, refer to the following resources:

- [SNS launch](https://internetcomputer.org/docs/current/developer-docs/daos/sns/launching/launch-summary-1proposal).

- [An introduction to SNS preparation](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/).

- [The SNS launch checklist](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/sns-checklist).

- [Pre-deployment considerations](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/predeployment-considerations).

- [SNS parameters](https://internetcomputer.org/docs/current/developer-docs/daos/sns/tokenomics/preparation).

- [Guidelines how to test an SNS locally](https://internetcomputer.org/docs/current/developer-docs/daos/sns/testing/testing-locally).

- [Guidelines how to test the operation of the dapp under SNS control](https://internetcomputer.org/docs/current/developer-docs/daos/sns/testing/testing-on-mainnet).

- [Stages included in an SNS launch](https://internetcomputer.org/docs/current/developer-docs/daos/sns/launching/launch-summary-1proposal).

- [SNS proposals](https://internetcomputer.org/docs/current/developer-docs/daos/sns/managing/making-proposals).

- [Tips regarding cycles management for the canisters](https://internetcomputer.org/docs/current/developer-docs/daos/sns/managing/cycles-usage).

- [An introduction to how to use the asset canister with an SNS-controlled dapp](https://internetcomputer.org/docs/current/developer-docs/daos/sns/managing/sns-asset-canister).

## Using the NNS dapp

To use the NNS dapp, first navigate to the dapp's URL at https://nns.ic0.app/.

You will be prompted to log in with your Internet Identity. If you need to create one, check out the previous module [4. Identities and authentication](/docs/developer-journey/level-2/4-identities-and-auth.mdx).
...
For additional information the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](https://internetcomputer.org/docs/current/developer-docs/daos/nns/nns-app-quickstart).
...
- [5. Using quill](/docs/developer-journey/level-3/4-nns-and-staking.mdx).
